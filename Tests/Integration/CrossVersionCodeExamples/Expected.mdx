...
Here comes a structure of allowed options inside a codeblock
...
Option 3: This description should really not be three sentences. I do not see why this should have. And yet it does.

...
To generate Get-Help pages for any PowerShell module run one of the following commands.
...
```powershell
# advanced use case supporting CommandHelp object pre-processing
$commandHelp = New-CommandHelp -CommandInfo (Get-Command -Module "YourModuleName")
